...
# Mapping keyboardCommands to specific keys for use with Elite Dangerous
...
def start_server():
    ...
    while True:
        ...
        # For simulating
        if convertedKey == DIK_I:
            PressKey(DIK_I)
            time.sleep(0.35)
            ReleaseKey(DIK_I)
        elif convertedKey == DIK_L:
            PressKey(DIK_L)
            time.sleep(0.35)
            ReleaseKey(DIK_L)
        elif convertedKey == DIK_T:
            PressKey(DIK_T)
            time.sleep(0.35)
            ReleaseKey(DIK_T)
        elif convertedKey == DIK_C:
            PressKey(DIK_C)
            time.sleep(0.35)
            ReleaseKey(DIK_C)
        else:
...
class SocketHandler(websocket.WebSocketHandler):
    ...
    def on_message(self, message):
        ...
        convertedKey = convertKBCommand(message)
        print convertedKey
